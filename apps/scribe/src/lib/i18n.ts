...
const it = {
  ...
  "score.penaltyHint": "I tocchi si sommano: il totale segue il dettato del giudice",
  "score.penaltyClear": "Azzera",
  "score.hold": "Trattieni · score in review",
  "score.holdManeuver": "La manovra del dubbio (facoltativa: al drag il confronto parte già informato)",
  ...
  "sign.title": "Firma del blocco",
  "sign.intro": "Il drag è il momento della firma: review risolte, poi il giudice rivede i totali del blocco e firma. Dopo la firma le carte sono definitive. (Un blocco saltato si firma al drag dopo.)",
...
const en = {
  ...
  "block.drag": "— DRAG —",
  "block.sign": "Sign the block · {n} cards",
  "block.missingClosed": "{n} not closed",
  "block.inReview": "{n} in review",
  "block.signed": "Block signed",
  "run.waiting": "Waiting",
  ...
  "score.penaltyHint": "Taps add up: the total follows the judge's call",
  "score.penaltyClear": "Clear",
  "score.hold": "Hold · score in review",
  "score.holdManeuver": "The maneuver in doubt (optional: at the drag the comparison starts informed)",
  ...
  "sign.title": "Block signing",
  "sign.intro": "The drag is signing time: reviews resolved, then the judge reviews the block's totals and signs. After signing, cards are final. (A skipped block gets signed at the next drag.)",
