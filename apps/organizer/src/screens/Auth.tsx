...
// nello stesso schermo. Verifica a doppia via (BR-82): il link nell'email
// arriva qui come ?verify=<token> e si consuma da solo; chi legge l'email su
// un altro dispositivo digita il codice a 6 cifre. ?reset=<token> apre la
// scelta della nuova password (loop del "password dimenticata").

const CLIENT_APP = "organizer" as const;
